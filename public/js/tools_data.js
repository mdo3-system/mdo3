...
const MDO3_TOOLS_CATALOG = [
  ...
  // ==========================================
  // カテゴリ2: 木造軸組・接合部系 (7ツール) - 利用頻度順
  // ①Z低減係数、②めり込み補強、③屋根ふき材、④柱の曲げ、⑤はしご垂木、⑥片持ち庇、⑦梁上耐力壁の剛性低減
  // ==========================================
  {
    id: "zi",
    category: "timber",
  ...
  // ==========================================
  // カテゴリ4: WRC造パッケージ (3ツール) - 利用頻度順
  // ①WRC一括検定、②長期軸力分割、③開口部補強・割増し検討（水平構面より移設）
  // ==========================================
  {
    id: "wrc_simulator",
    category: "wrc",
